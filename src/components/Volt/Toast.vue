...
const theme = ref<ToastPassThroughOptions>({
    root: `left-[5px] rounded-md whitespace-pre-line break-words
    ...
    message: `backdrop-blur-[10px] mb-2 shadow-md not-p-custom:border not-p-custom:backdrop-blur-sm dark:not-p-custom:backdrop-blur-md not-p-custom:rounded
    ...
    messageContent: `flex items-center py-3 px-6 gap-2`,
