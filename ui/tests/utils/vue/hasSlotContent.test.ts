...
import { hasSlotContent } from '../../../src/utils/vue/hasSlotContent';
import { h } from 'vue';
...
describe('hasSlotContent', () => {
    ...
    it('should return true when slot content has component', () => {
        const MyComponent = {};
        const componentSlot = () => [{ type: MyComponent }];
